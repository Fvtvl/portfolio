    ...
    <div name='home' 
        ...
        <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row'>
            <div className='flex flex-col justify-center h-full mt-16 sm:mt-0'>
                ...
                <p className='text-gray-500 py-4 max-w-md'>I am really passionate about working with React.js, using  JavaScript libraries like Axios, Webpack, Babel, and others.
                <p>Self-study and the ability to Google is the best way for me to solve any problem.</p></p>
                <div>
